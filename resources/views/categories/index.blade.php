...
<div class="home">
							...
							<div class="sorting">
								<ul class="item_sorting">
									<li>
										...
										<ul>
											<li class="product_sorting_btn_click" data-order="default"><span>Default</span></li>
                      <li class="product_sorting_btn_click" data-order="price-low-high"><span>Price: Low-High</span></li>
											<li class="product_sorting_btn_click" data-order="price-high-low"><span>Price: High-Low</span></li>
                      <li class="product_sorting_btn_click" data-order="name-a-z"><span>Name: A-Z</span></li>
											<li class="product_sorting_btn_click" data-order="name-z-a"><span>Name: Z-A</span></li>
										</ul>
									</li>
								</ul>
							</div>
              ...
              ?>
						...
						<div class="product">
							...
							<div class="product_content">
								<div class="product_title"><a href="{{route('showProduct',['showCategory', $product->id])}}">{{ $product->title }}</a></div>
  ...
  <script>
    $(document).ready(function () {
     $('.product_sorting_btn_click').click(function () {
